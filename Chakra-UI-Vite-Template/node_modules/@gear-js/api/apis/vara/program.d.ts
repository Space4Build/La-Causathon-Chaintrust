import { HexString, IProgramCreateResult, IProgramUploadResult, VaraProgramCreateOptions, VaraProgramUploadOptions } from '../../types';
...
export declare class VaraProgram extends GearProgram {
    ...
    upload(args: VaraProgramUploadOptions, metaOrHexRegistry?: ProgramMetadata | HexString, typeName?: string): IProgramUploadResult;
    ...
    create(args: VaraProgramCreateOptions, metaOrHexRegistry?: ProgramMetadata | `0x${string}`, typeName?: string | number): IProgramCreateResult;
}
