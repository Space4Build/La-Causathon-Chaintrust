...
class GearGas {
    ...
    async initUpload(sourceId, code, payload, value, allowOtherPanics, meta, typeIndexOrTypeName) {
        return this._api.rpc.gear.calculateInitUploadGas(sourceId, createPayload.encodePayload(code, undefined, undefined, 'Bytes'), createPayload.encodePayload(payload, meta, 'init', typeIndexOrTypeName), value || 0, allowOtherPanics || true);
    }
    /**
    ...
    async initCreate(sourceId, codeId, payload, value, allowOtherPanics, meta, typeIndexOrTypeName) {
        const _payload = createPayload.encodePayload(payload, meta, 'init', typeIndexOrTypeName);
    ...
    async reply(sourceId, messageId, payload, value, allowOtherPanics, meta, typeIndexOrTypeName) {
        const _payload = createPayload.encodePayload(payload, meta, 'reply', typeIndexOrTypeName);
