...
declare module '@polkadot/api-base/types/storage' {
    interface AugmentedQueries<ApiType extends ApiTypes> {
        ...
        gearMessenger: {
            ...
            dispatches: AugmentedQuery<ApiType, (arg: GearCoreIdsMessageId | string | Uint8Array) => Observable<Option<GearCommonStorageComplicatedDequeueLinkedNode>>, [
                GearCoreIdsMessageId
            ]> & QueryableStorageEntry<ApiType, [GearCoreIdsMessageId]>;
            dispatchStash: AugmentedQuery<ApiType, (arg: GearCoreIdsMessageId | string | Uint8Array) => Observable<Option<ITuple<[GearCoreMessageStoredStoredDispatch, GearCommonStoragePrimitivesInterval]>>>, [
                GearCoreIdsMessageId
            ]> & QueryableStorageEntry<ApiType, [GearCoreIdsMessageId]>;
            head: AugmentedQuery<ApiType, () => Observable<Option<U8aFixed>>, []> & QueryableStorageEntry<ApiType, []>;
            mailbox: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: GearCoreIdsMessageId | string | Uint8Array) => Observable<Option<ITuple<[GearCoreMessageUserUserStoredMessage, GearCommonStoragePrimitivesInterval]>>>, [
                AccountId32,
                GearCoreIdsMessageId
            ...
            waitlist: AugmentedQuery<ApiType, (arg1: GearCoreIdsProgramId | string | Uint8Array, arg2: GearCoreIdsMessageId | string | Uint8Array) => Observable<Option<ITuple<[GearCoreMessageStoredStoredDispatch, GearCommonStoragePrimitivesInterval]>>>, [
        ...
        gearProgram: {
            codeLenStorage: AugmentedQuery<ApiType, (arg: GearCoreIdsCodeId | string | Uint8Array) => Observable<Option<u32>>, [
                GearCoreIdsCodeId
            ]> & QueryableStorageEntry<ApiType, [GearCoreIdsCodeId]>;
            codeStorage: AugmentedQuery<ApiType, (arg: GearCoreIdsCodeId | string | Uint8Array) => Observable<Option<GearCoreCodeInstrumentedCode>>, [
                GearCoreIdsCodeId
            ]> & QueryableStorageEntry<ApiType, [GearCoreIdsCodeId]>;
            memoryPageStorage: AugmentedQuery<ApiType, (arg1: GearCoreIdsProgramId | string | Uint8Array, arg2: u32 | AnyNumber | Uint8Array) => Observable<Option<Bytes>>, [
                GearCoreIdsProgramId,
                u32
            ]> & QueryableStorageEntry<ApiType, [GearCoreIdsProgramId, u32]>;
            metadataStorage: AugmentedQuery<ApiType, (arg: GearCoreIdsCodeId | string | Uint8Array) => Observable<Option<GearCommonCodeMetadata>>, [
                GearCoreIdsCodeId
            ]> & QueryableStorageEntry<ApiType, [GearCoreIdsCodeId]>;
            originalCodeStorage: AugmentedQuery<ApiType, (arg: GearCoreIdsCodeId | string | Uint8Array) => Observable<Option<Bytes>>, [
                GearCoreIdsCodeId
            ]> & QueryableStorageEntry<ApiType, [GearCoreIdsCodeId]>;
            pausedProgramStorage: AugmentedQuery<ApiType, (arg: GearCoreIdsProgramId | string | Uint8Array) => Observable<Option<ITuple<[u32, H256]>>>, [
                GearCoreIdsProgramId
            ]> & QueryableStorageEntry<ApiType, [GearCoreIdsProgramId]>;
            programStorage: AugmentedQuery<ApiType, (arg: GearCoreIdsProgramId | string | Uint8Array) => Observable<Option<GearCommonProgram>>, [
                GearCoreIdsProgramId
            ]> & QueryableStorageEntry<ApiType, [GearCoreIdsProgramId]>;
            resumeSessions: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<GearCommonPausedProgramStorageResumeSession>>, [
                u128
            ]> & QueryableStorageEntry<ApiType, [u128]>;
            resumeSessionsNonce: AugmentedQuery<ApiType, () => Observable<Option<u128>>, []> & QueryableStorageEntry<ApiType, []>;
            sessionMemoryPages: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<Vec<ITuple<[u32, Bytes]>>>>, [
                u128
            ]> & QueryableStorageEntry<ApiType, [u128]>;
            waitingInitStorage: AugmentedQuery<ApiType, (arg: GearCoreIdsProgramId | string | Uint8Array) => Observable<Option<Vec<GearCoreIdsMessageId>>>, [
                GearCoreIdsProgramId
            ]> & QueryableStorageEntry<ApiType, [GearCoreIdsProgramId]>;
            /**
             * Generic query
        ...
        gearScheduler: {
            ...
            taskPool: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: GearCommonSchedulerTaskScheduledTask | {
                PauseProgram: any;
            } | {
                RemoveCode: any;
            } | {
