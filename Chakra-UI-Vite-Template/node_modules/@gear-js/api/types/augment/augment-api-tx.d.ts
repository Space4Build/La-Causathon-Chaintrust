...
declare module '@polkadot/api-base/types/submittable' {
    interface AugmentedSubmittables<ApiType extends ApiTypes> {
        gear: {
             ...
             **/
            claimValue: AugmentedSubmittable<(messageId: GearCoreIdsMessageId | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
             ...
             **/
            createProgram: AugmentedSubmittable<(codeId: GearCoreIdsCodeId | string | Uint8Array, salt: Bytes | string | Uint8Array, initPayload: Bytes | string | Uint8Array | number[], gasLimit: u64 | AnyNumber | Uint8Array, value: u128 | AnyNumber | Uint8Array, keepAlive: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                GearCoreIdsCodeId,
                Bytes,
                Bytes,
                u64,
             ...
             **/
            payProgramRent: AugmentedSubmittable<(programId: GearCoreIdsProgramId | string | Uint8Array, blockCount: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
             ...
             **/
            resumeSessionCommit: AugmentedSubmittable<(sessionId: u128 | AnyNumber | Uint8Array, blockCount: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                u128,
                u32
            ]>;
            /**
             ...
             **/
            resumeSessionInit: AugmentedSubmittable<(programId: GearCoreIdsProgramId | string | Uint8Array, allocations: BTreeSet<u32> | number[], codeHash: GearCoreIdsCodeId | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                GearCoreIdsProgramId,
                BTreeSet<u32>,
                GearCoreIdsCodeId
            ]>;
             ...
             **/
            resumeSessionPush: AugmentedSubmittable<(sessionId: u128 | AnyNumber | Uint8Array, memoryPages: Vec<ITuple<[u32, Bytes]>> | [u32 | AnyNumber | Uint8Array, Bytes | string | Uint8Array][] | string) => SubmittableExtrinsic<ApiType>, [
                u128,
             ...
             **/
            sendMessage: AugmentedSubmittable<(destination: GearCoreIdsProgramId | string | Uint8Array, payload: Bytes | string | Uint8Array | number[], gasLimit: u64 | AnyNumber | Uint8Array, value: u128 | AnyNumber | Uint8Array, keepAlive: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                GearCoreIdsProgramId,
                Bytes,
                u64,
                u128,
             ...
             * or reply on the message from mailbox.
             **/
            sendReply: AugmentedSubmittable<(replyToId: GearCoreIdsMessageId | string | Uint8Array, payload: Bytes | string | Uint8Array | number[], gasLimit: u64 | AnyNumber | Uint8Array, value: u128 | AnyNumber | Uint8Array, keepAlive: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                GearCoreIdsMessageId,
                Bytes,
                u64,
                u128,
             ...
             * has been removed.
             **/
            uploadProgram: AugmentedSubmittable<(code: Bytes | string | Uint8Array, salt: Bytes | string | Uint8Array, initPayload: Bytes | string | Uint8Array | number[], gasLimit: u64 | AnyNumber | Uint8Array, value: u128 | AnyNumber | Uint8Array, keepAlive: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                Bytes,
                Bytes,
                Bytes,
                u64,
        ...
        gearVoucher: {
             ...
             **/
            call: AugmentedSubmittable<(call: PalletGearVoucherPrepaidCall | {
                SendMessage: any;
            } | {
                SendReply: any;
             ...
             **/
            issue: AugmentedSubmittable<(to: MultiAddress | {
                Id: any;
            } | {
                Index: any;
            } | {
                ...
                Address20: any;
            } | string | Uint8Array, program: GearCoreIdsProgramId | string | Uint8Array, value: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                MultiAddress,
                GearCoreIdsProgramId,
                u128
            ]>;
