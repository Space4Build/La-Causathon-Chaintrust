...
import { IProgramCreateOptions, IProgramCreateResult, IProgramUploadOptions, IProgramUploadResult, VaraProgramCreateOptions, VaraProgramUploadOptions } from './types';
...
export declare class GearProgram extends GearTransaction {
    ...
    resumeSession: GearResumeSession;
     ...
     * ```
     */
    upload(args: IProgramUploadOptions | VaraProgramUploadOptions, meta?: ProgramMetadata, typeIndex?: number): IProgramUploadResult;
    /**
     ...
     * @returns Object containing program id, generated (or specified) salt, code id, prepared extrinsic
     */
    upload(args: IProgramUploadOptions | VaraProgramUploadOptions, hexRegistry: HexString, typeIndex: number): IProgramUploadResult;
     ...
     */
    upload(args: IProgramUploadOptions | VaraProgramUploadOptions, metaOrHexRegistry?: ProgramMetadata | HexString, typeName?: string): IProgramUploadResult;
    /**
     ...
     * ```
     */
    create(args: IProgramCreateOptions | VaraProgramCreateOptions, meta?: ProgramMetadata, typeIndex?: number | null): IProgramCreateResult;
    /**
     * ### Create program from uploaded on chain code using program metadata to encode payload
     * @param args Program parameters
     * @param hexRegistry Registry presented as Hex string
     ...
     * @returns Object containing program id, generated (or specified) salt, prepared extrinsic
     */
    create(args: IProgramCreateOptions | VaraProgramCreateOptions, hexRegistry: HexString, typeIndex: number): IProgramCreateResult;
     ...
     */
    create(args: IProgramCreateOptions | VaraProgramCreateOptions, metaOrHexRegistry?: HexString | ProgramMetadata, typeName?: number | string): IProgramCreateResult;
    /**
     * ### Pay program rent
     * @param programId
     * @param blockCount
