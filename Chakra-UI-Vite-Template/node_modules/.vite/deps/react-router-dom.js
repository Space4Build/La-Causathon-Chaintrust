...
function useNavigate() {
  ...
  let navigate = React.useCallback(function(to, options) {
    ...
    import_process.default.env.NODE_ENV !== "production" ? warning(activeRef.current, "You should call navigate() in a React.useEffect(), not when your component is first rendered.") : void 0;
...
function _renderMatches(matches, parentMatches, dataRouterState) {
  ...
  if (errors != null) {
    ...
    !(errorIndex >= 0) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "Could not find a matching route for the current errors: " + errors) : invariant(false) : void 0;
...
function useActionData() {
  ...
  let route = React.useContext(RouteContext);
  !route ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "useActionData must be used inside a RouteContext") : invariant(false) : void 0;
...
function detectErrorBoundary(route) {
  if (import_process.default.env.NODE_ENV !== "production") {
    if (route.Component && route.element) {
      import_process.default.env.NODE_ENV !== "production" ? warning(false, "You should not include both `Component` and `element` on your route - `element` will be ignored.") : void 0;
    }
    if (route.ErrorBoundary && route.errorElement) {
      import_process.default.env.NODE_ENV !== "production" ? warning(false, "You should not include both `ErrorBoundary` and `errorElement` on your route - `errorElement` will be ignored.") : void 0;
    }
  }
...
function useSubmitImpl(fetcherKey, routeId) {
  ...
  return React2.useCallback(function(target, options) {
    ...
    if (fetcherKey) {
      !(routeId != null) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "No routeId available for useFetcher()") : invariant(false) : void 0;
...
function useFetcher() {
  ...
  let [Form2] = React2.useState(() => {
    !routeId ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "No routeId available for fetcher.Form()") : invariant(false) : void 0;
    return createFetcherForm(fetcherKey, routeId);
  });
  let [load] = React2.useState(() => (href) => {
    !router ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "No router available for fetcher.load()") : invariant(false) : void 0;
